...
class OpenAIReader(BaseReader):
    ...
    def build_context(self, documents: List[dict]) -> str:
        """
        Format a list of document dicts into a single string context block.
        Each document is labeled and includes metadata for transparency.
        """
        formatted_docs = []
    ...
    def answer(self, query: str, documents: List[str]) -> str:
        """Generate an answer from the query and the context documents."""
